...
Git commit: 24ebd758fea39e4c8a41e1ee84865b0e9f7189bc
Launcher: scripts/launch_brier_judge_trajectory.sh
Evaluation interval: 2026-08-17T19:23:00 through 2026-08-17T20:25:38 UTC.

Generator run: 9b_full5ep_kl1e4_lr1e4_temp1, training job 14217.
Pair checkpoints: steps 0, 64, 128, 192, 256, and 320. Step 0 is the shared
SFT initialization; the other steps are one checkpoint per GRPO epoch.
...
provenance/baseline_reuse.json. New scoring jobs were:
  ...
  step 256  18457
  step 320  18458
All six jobs, including reused step 0, are listed in judge_jobs.csv.
...
The six pair parquets were copied byte-for-byte from:
...
provenance/expected_runtime.json and provenance/jobs/<job_id>/runtime.json.

MECHANICAL VALIDATION
---------------------
All six cells contain exactly 880 expected unique pair keys, with zero missing,
extra, or duplicate keys. Valid Likert counts by step were 877, 875, 876, 878,
877, and 877. See validation.txt and summary_judge-9b-brier.csv.
...
---------------
  ...
  provenance/ (launch, runtime, model-merge, baseline-reuse, and pair manifests)
  SHA256SUMS

REPRODUCTION
------------
Submit the five new epoch-boundary cells from a clean retained commit:
...
Regenerate the summary and strict validation on the cluster:
