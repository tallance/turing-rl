...
def test_default_is_no_clip(monkeypatch):
    # Project default is NO clip: with the env unset, the whole 1-7 Likert passes through.
    # (Upstream default was 5.0; see docs/default-params.md.)
