...
def write_report(
    ...
    lines += [
        ...
        "",
        "**Scripts involved**:",
        "- `scripts/slurm/judge_serve_8b_tp.sh` — parameterized judge (TP env var)",
        "- `scripts/benchmark_judge_throughput.py` — client benchmark",
        "- `scripts/launch_judge_throughput_sweep.sh` — orchestrator",
        "",
