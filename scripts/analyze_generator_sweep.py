...
CMP_METRICS = [
    ("acc_parse_ok", "effective-rating accuracy | parse ok (picks true human)", (0.0, 0.85), 0.5),
    ("acc_penalized", "effective-rating accuracy (parse-fail counted wrong)", (0.0, 0.85), 0.5),
