...
case "$JUDGE" in
  ...
  9b-ce2)    JUDGE_MODEL=/home/lancewicki/projects/turing-rl/checkpoints/sft/judge_qwen35_9b_ce_iter2_dense
             TP=1; DP=8; REASONING_PARSER=qwen3  ;;
  # Round 3 of the alternating loop: iter2 continued (--base_adapter) on generations from
  # generator round 2, slice [0.41,0.5045), again sampled at T=1.0.
  9b-ce3)    JUDGE_MODEL=/home/lancewicki/projects/turing-rl/checkpoints/sft/judge_qwen35_9b_ce_iter3_dense
             TP=1; DP=8; REASONING_PARSER=qwen3  ;;
