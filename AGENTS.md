...
- Before cluster submission, use the `preflight-job-check` skill, select the narrowest complete dependency profile, then launch through `scripts/cluster_launch.sh`.
